...
$(function () {
	function setUserAddress(address) {
		...
		$('.trxWalletTa125').html('<a href="https://parabellumtron.com/?ref=' + address + '"><img src="https://parabellumtron.com/img/125.gif" width="125" height="125" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
		$('.trxWalletTa468').html('<a href="https://parabellumtron.com/?ref=' + address + '"><img src="https://parabellumtron.com/img/468.gif" width="468" height="60" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
		$('.trxWalletTa728').html('<a href="https://parabellumtron.com/?ref=' + address + '"><img src="https://parabellumtron.com/img/728.gif" width="728" height="90" alt="TRONex.net | Get +200% up to your deposit right now. Safe and legit!"></a>');
		$('.reflink').html('https://parabellumtron.com/?ref=' + address);
		$('#reflink').val('https://parabellumtron.com/?ref=' + address)
	}
